...
REQUIRED_FILES = [
    ...
    "code/exact_and_self_belief_experiments.py",
    "data/manifest.csv",
    "data/generated/exact_and_self_belief/exact_benchmark/best_response_alpha_0p2.csv",
    "data/generated/exact_and_self_belief/exact_benchmark/best_response_alpha_0p28.csv",
